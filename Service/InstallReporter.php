...
{
    public const MAGENTO_MODULE = 'Panth_ErrorMonitor';
    public const COMPOSER_PACKAGE = 'mage2kishan/module-error-monitor';
    ...
    private function resolveComposerPackage(string $magentoModule): string
    {
        try {
            ...
            return is_array($data) && isset($data['name']) && is_string($data['name']) ? $data['name'] : '';
        } catch (\Throwable) {
            return '';
        }
    }
